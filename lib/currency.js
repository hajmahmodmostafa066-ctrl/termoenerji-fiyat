...
export const getKurlar = async () => {
  // Önbellek varsa ve 60 saniyeden az geçmişse önbellekten döndür
...
export const setKurlar = async (usdTry, eurTry) => {
  try {
    ...
    // Önbelleği güncelle ve dinleyicileri haberdar et
    kurCache = yeniKurlar
    kurCacheTime = Date.now()
...
// Fiyat çevirisi (kurları parametre olarak alır)
